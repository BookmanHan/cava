...
//const int type_struct = 1;
//const int type_var = 2;
//const int type_string = 3;
//const int type_char = 4;
//const int type_const = 5;
//const int type_oper = 6;
//const int type_none = 7;
//const int type_const_double = 8;
//
//const int ctype_char = 1;
//const int ctype_short = 2;
//const int ctype_int = 3;
//const int ctype_unsigned_char = 4;
//const int ctype_unsigned_short = 5;
//const int ctype_unsigned_int = 6;
//const int ctype_double = 7;
//const int ctype_pointer = 8;
//const int ctype_pointer_random = 9;
//const int ctype_void = 10;
//
//const int seg_none = 0;
//const int seg_const = 1;
//const int seg_stack = 2;
//const int seg_heap = 3;
//
//
//
